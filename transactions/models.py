...
class Transaction(models.Model):
    ...
    received_amount = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, help_text='Сумма после конвертации и комисии')
    fee = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, help_text='Комиссия за перевод')
    exchange_rate = models.DecimalField(max_digits=10, decimal_places=4, null=True, blank=True, help_text='Курс: 1 from_currency = X to_currency')
